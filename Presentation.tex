...
\begin{frame}
	...
	\begin{itemize}
		...
		\item $m_{\pi^0}=\sqrt{2 E_1 E_2 (1-cos(\alpha))}$ with $E_1 \approx E_2$ $\rightarrow E_{max}\approx 250 \, \text{MeV}$
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item Simulation
		\item The $\pi^0$ decay in the origin of the target
		\item The $\pi^0$ are boosted isotropic with an energy of $ 1420\, \text{MeV}$ to $1580\, \text{MeV}$
	\end{itemize}
...
\begin{itemize}
	\item Simulation
	\item The angle between the generated and the reconstructed candidate is calculated
\end{itemize}
...
\begin{frame}
	\frametitle{Differenz Between The Gen. And The Rec. Opening Angle}
...
\begin{frame}
	...
	\begin{itemize}
		\item Simulation
		\item $\Delta \alpha$ for different energies and $z$-Vertices
	\end{itemize}
...
\begin{figure}
	...
	\includegraphics[width=0.35\textwidth]{Pictures/20170205DiffOeffZVertex+4_425MeV}	
	\caption{Simulation: $\Delta \alpha$ for different photon energies. Decay at the beginning of the target }
\end{figure}
